...
To get started you need to grab a copy of the matplotlylib repo. The makefile
included in this is all you need to get setup. Just do the following:
...
The project page has an extensive IPython notebook with example usage. Check
it out at:

http://nbviewer.ipython.org/github/mpld3/matplotlylib/blob/master/notebooks/Plotly%20and%20mpld3.ipynb

Or, have a look at our plotly profile, https://plot.ly/~mpld3/, where you can
open and edit all of the examples. If the NB is loading slowing, checkout our
static site hosted on GitHub page at: http://plotly.github.io/matplotlylib/.
